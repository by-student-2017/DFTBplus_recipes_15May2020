...
move dos_spin.png .\plot\dos_ru.s.png
move dos_spin.plot .\plot\dos_ru.s.plot

find /v "KPT" <dos_ru.2.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ru.p.png
move dos_spin.plot .\plot\dos_ru.p.plot

find /v "KPT" <dos_ru.3.out> dos.dat
gnuplot pdos_spin.gp
move dos_spin.png .\plot\dos_ru.d.png
move dos_spin.plot .\plot\dos_ru.d.plot
